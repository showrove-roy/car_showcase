...
const Footer = () => {
  return (
    <footer className='text-black mt-5 border-t border-gray-100'>
      <div className='max-w-[1440px] mx-auto flex flex-col sm:px-16 px-6'>
        ...
        <div className='flex justify-between items-center flex-wrap mt-10 border-t border-gray-100 py-10'>
          <p>@2023 CaHub. All Right Reserved</p>
